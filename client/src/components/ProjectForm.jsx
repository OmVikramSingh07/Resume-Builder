  ...
  return (
    <div>
        <div className='flex items-center justify-between'>
            ...
            <button onClick={addProject} className='flex items-center gap-2px-3 py-1 text-sm bg-purple-100 text-purple-700 rounded hover:bg-purple-200 transition-colors '>
