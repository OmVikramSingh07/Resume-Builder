...
const Features = () => {
  ...
  return (
            <div id='features' className='flex flex-col items-center my-10 scroll-mt-12'>
                ...
                <Title title='Build your resume' description='Our streamline process helps you create a professional resume in minutes with intelligent Ai-powered tools and festures.'/>
