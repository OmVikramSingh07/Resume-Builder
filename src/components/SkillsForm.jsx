  ...
  return (
    <div className='space-y-4'>
        ...
        <div className='flex gap-2'>
            <input type='text' placeholder='Enter a skill (e.g., JavaScript, Project Management)' className='flex-1 px-3py-2 text-sm' onChange={(e) => setNewSkill(e.target.value)} value={newSkill} onKeyDown={handleKeyPress}/>
