  ...
  return (
    <div className='space-y-6'>
        <div className='flex items-center justify-between'>
            ...
            <button onClick={addExperience} className='flex items-center gap-2px-3 py-1 text-sm bg-purple-100 text-purple-700 rounded hover:bg-purple-200 transition-colors '>
                    ...
                    <div key={index} className='p-4 order border-gray-200 rounded-lg space-y-3'>
                        ...
                        <div className='space-y-2'>
                            <div className='flex items-center justify-between'>
                                ...
                                <button className='flex items-center gap-1 px-2 py-1 text-xs bg-purple-100 text-purple-700 rounded hover:bg-bg-purple-200 transition-colors disabled:opacity-50'>
